...
export type StorageHash =
  StorageHashBase<'320e671143e2977b6de8587d389db4ea7f5bc29dd1aa6ce96595e5948ec82d78'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Message: {
      ...
      readonly mentions: CodecTypes['pg/json@1']['output'] | null;
      readonly recalledAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    ...
    readonly Session: {
      ...
      readonly announcement: CodecTypes['pg/text@1']['output'] | null;
      readonly announcementAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly announcementById: CodecTypes['pg/int4@1']['output'] | null;
      readonly muteAll: CodecTypes['pg/bool@1']['output'];
      readonly userAId: CodecTypes['pg/int4@1']['output'] | null;
      readonly userBId: CodecTypes['pg/int4@1']['output'] | null;
      readonly lastMessageId: CodecTypes['pg/int4@1']['output'] | null;
      readonly lastMessageAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly lastReadAtA: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly lastReadAtB: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Message: {
      ...
      readonly mentions: CodecTypes['pg/json@1']['input'] | null;
      readonly recalledAt: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly MessageReaction: {
    ...
    readonly Session: {
      ...
      readonly announcement: CodecTypes['pg/text@1']['input'] | null;
      readonly announcementAt: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly announcementById: CodecTypes['pg/int4@1']['input'] | null;
      readonly muteAll: CodecTypes['pg/bool@1']['input'];
      readonly userAId: CodecTypes['pg/int4@1']['input'] | null;
      readonly userBId: CodecTypes['pg/int4@1']['input'] | null;
      readonly lastMessageId: CodecTypes['pg/int4@1']['input'] | null;
      readonly lastMessageAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly lastReadAtA: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly lastReadAtB: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly SessionMember: {
      readonly sessionId: CodecTypes['pg/int4@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly messageReaction: {
              ...
              primaryKey: { readonly columns: readonly ['messageId', 'userId', 'emoji'] };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'messageReaction_messageId_idx_3cdded8d';
                  readonly prefix: 'messageReaction_messageId_idx';
                  readonly columns: readonly ['messageId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'messageReaction_userId_idx_a489d58a';
                  readonly prefix: 'messageReaction_userId_idx';
            ...
            readonly session: {
              columns: {
                ...
                readonly announcementAt: {
                  readonly nativeType: 'timestamptz';
                  readonly codecId: 'pg/timestamptz-string@1';
                  readonly nullable: true;
                };
                readonly announcementById: {
                  readonly nativeType: 'int4';
                  readonly codecId: 'pg/int4@1';
                  readonly nullable: true;
                };
                ...
                readonly lastReadAtA: {
                  readonly nativeType: 'timestamptz';
                  readonly codecId: 'pg/timestamptz-string@1';
                  readonly nullable: true;
                };
                readonly lastReadAtB: {
                  readonly nativeType: 'timestamptz';
                  readonly codecId: 'pg/timestamptz-string@1';
                  readonly nullable: true;
                };
            ...
            readonly sessionMember: {
              ...
              primaryKey: { readonly columns: readonly ['sessionId', 'userId'] };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'sessionMember_userId_idx_a489d58a';
                  readonly prefix: 'sessionMember_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'sessionMember_sessionId_idx_29f415d4';
                  readonly prefix: 'sessionMember_sessionId_idx';
                  readonly columns: readonly ['sessionId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'sessionMember';
                    readonly columns: readonly ['sessionId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
          ...
          readonly Message: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly recalledAt: { readonly column: 'recalledAt' };
                readonly createdAt: { readonly column: 'createdAt' };
              };
            };
          };
          ...
          readonly Session: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly announcement: { readonly column: 'announcement' };
                readonly announcementAt: { readonly column: 'announcementAt' };
                readonly announcementById: { readonly column: 'announcementById' };
                readonly muteAll: { readonly column: 'muteAll' };
                readonly userAId: { readonly column: 'userAId' };
                readonly userBId: { readonly column: 'userBId' };
                readonly lastMessageId: { readonly column: 'lastMessageId' };
                readonly lastMessageAt: { readonly column: 'lastMessageAt' };
                readonly lastReadAtA: { readonly column: 'lastReadAtA' };
                readonly lastReadAtB: { readonly column: 'lastReadAtB' };
                readonly createdAt: { readonly column: 'createdAt' };
              };
            };
          };
