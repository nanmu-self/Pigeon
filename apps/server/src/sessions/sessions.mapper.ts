import type { PublicUser, SessionSummary, WsChatMessage } from '@pigeon/shared-types';
...
export function toChatMessage(row: MessageRow, senderName: string): WsChatMessage {
  return {
    id: String(row.id),
